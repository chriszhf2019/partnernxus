...
function normalizeDeal(row: any): Deal {
  return {
    ...
    actualPartnerId: row.actual_partner_id || row.actualPartnerId || undefined,
    actualPartnerName: row.actual_partner_name || row.actualPartnerName || undefined,
...
function toSnakeDeal(deal: Partial<Deal>): Record<string, any> {
  ...
  const map: Record<string, string> = {
    ...
    actualPartnerId: 'actual_partner_id',
    actualPartnerName: 'actual_partner_name',
