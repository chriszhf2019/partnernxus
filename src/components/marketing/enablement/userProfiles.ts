...
const profiles: Record<string, UserProfile> = {
  ...
  '赵强': { hireDate: '2021-05', passRate: 90, manager: '李总监', department: '技术部', region: '华东' },
  '陈晓东': { hireDate: '2023-01', passRate: 75, manager: '王经理', department: '销售部', region: '华北' },
  '刘娜': { hireDate: '2024-02', passRate: 55, manager: '赵总监', department: '技术部', region: '华南' },
  '孙浩': { hireDate: '2022-09', passRate: 92, manager: '刘总监', department: '技术部', region: '华东' },
  '周丽': { hireDate: '2021-12', passRate: 88, manager: '王经理', department: '销售部', region: '华北' },
};
