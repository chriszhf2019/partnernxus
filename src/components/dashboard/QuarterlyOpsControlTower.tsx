    ...
    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 w-full">
        ...
        <div className="space-y-6 flex-1">
          ...
          <div className="space-y-3">
            ...
            <div className="h-3 w-full flex rounded-full overflow-hidden bg-slate-50 border border-black/5 dark:border-white/5 shadow-inner">
              ...
              <motion.div initial={{ width: 0 }} animate={{ width: '30%' }} className="h-full bg-[#f5f5f7]0" title="金牌: 30%" />
            ...
            <div className="flex flex-wrap gap-4 pt-1">
              ...
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 rounded-full bg-[#f5f5f7]0 shadow-sm" />
          ...
          <div className="pt-5 border-t border-black/5">
            ...
            <div className="flex items-end gap-3">
              <h3 className="text-3xl font-black text-black dark:text-white tracking-tighter">12 / 18</h3>
            ...
            <p className="text-[10px] font-bold text-slate-500 dark:text-slate-500 mt-2 leading-relaxed italic">目前 2/3 的高阶伙伴已锁定季度基准目标</p>
          </div>
      ...
      <div className="bg-white dark:bg-[#1c1c1e] p-6 rounded-[2.5rem] shadow-sm border border-black/5 dark:border-white/5 flex flex-col h-full group hover:shadow-xl hover:shadow-indigo-500/5 transition-all">
        ...
        <div className="space-y-6 flex-1">
          <div>
            ...
            <h3 className="text-4xl font-black text-black dark:text-white tracking-tighter">¥105M</h3>
          </div>

          <div className="space-y-4">
            {[
              { label: '白金级 (Platinum)', value: '¥42M', width: 90, color: 'bg-black' },
              ...
              <div key={item.label} className="space-y-2 group/bar">
                <div className="flex justify-between text-[10px] font-black">
                  <span className="text-slate-500 dark:text-slate-500 group-hover/bar:text-indigo-600 transition-colors uppercase tracking-tight">{item.label}</span>
                  <span className="text-black dark:text-white font-mono tracking-tighter">{item.value}</span>
                </div>
        ...
        <div className="space-y-6 flex-1">
          ...
          <div className="p-4 bg-slate-50 border border-black/5 dark:border-white/5 rounded-2xl">
            ...
            <div className="flex gap-2">
              ...
              <span className="px-3 py-1.5 bg-white text-slate-500 dark:text-slate-500 text-[9px] font-black rounded-xl border border-slate-200">本月剩余: 6</span>
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-6 pt-2">
            ...
            <div className="space-y-1">
              ...
              <div className="flex items-center gap-2">
                <h3 className="text-2xl font-black text-black dark:text-white tracking-tighter">22.4%</h3>
      ...
      <div className="bg-white dark:bg-[#1c1c1e] p-6 rounded-[2.5rem] shadow-sm border border-black/5 dark:border-white/5 flex flex-col h-full group hover:shadow-xl hover:shadow-orange-500/5 transition-all">
        ...
        <div className="space-y-5 flex-1">
          {[
            { name: 'Core Product Rebate', progress: 68, color: 'bg-black' },
            { name: 'New Logo Hunter', progress: 42, color: 'bg-orange-500' },
            { name: 'Cloud Migration SP', progress: 85, color: 'bg-black' },
          ].map((item) => (
          ...
          <button onClick={() => onNavigate?.('marketing')} className="w-full mt-auto py-4 bg-white border border-slate-200 text-black dark:text-white text-[10px] font-black uppercase tracking-[0.2em] rounded-2xl hover:bg-slate-50 transition-all flex items-center justify-center gap-3 shadow-sm group/btn">
